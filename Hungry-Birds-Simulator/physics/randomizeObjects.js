	...
	for(let i=0; i<9; i++){
        ...
        switch(i){
            ...
            case 2:
             ...
             case 3:
                pig21 = pigChoiche;
                structureObjs.push(new structureObjects(0.0, 0.6 , 5.0, 270.0, 0.0, 0.0, objType ));
                break;
            case 4:
                pig22 = pigChoiche;
            ...
            case 6:
                pig24 = pigChoiche;
                structureObjs.push(new structureObjects(0.0, 4.0 , 5.0, 270.0, 0.0, 0.0, objType ));
                break;
            case 7:
                pig25 = pigChoiche;
                structureObjs.push(new structureObjects(0.0, 6.8 , 5.0, 270.0, 0.0, 0.0, objType ));
                break;
            case 8:
                pig31 = pigChoiche;
                structureObjs.push(new structureObjects(0.0, 2.1 , 7.8, 270.0, 0.0, 0.0, objType ));
                break;
...
function defineStructureObjs(tnt, glassBox, woodBox, stoneBox, stoneSquare, woodPyramid, glassPyramid, stonePyramid, glassVerticalPlane, woodVerticalPlane, glassHorizontalPlane, woodHorizontalPlane){
    ...
    tower31 = tnt;
    structureObjs.push(new structureObjects(0.0, 1.6 , 7.2, 0.0, 0.0, 0.0,  "tnt" ));

    tower32 = tnt;
    structureObjs.push(new structureObjects(0.0, 1.6 , 7.8, 0.0, 0.0, 0.0,  "tnt" ));
    
    tower33 = tnt;
    structureObjs.push(new structureObjects(0.0, 1.6 , 8.6, 0.0, 0.0, 0.0,  "tnt" ));
...
function randomizeHorizontalPlane(glassHorizontalPlane, woodHorizontalPlane){
    for(let i=0; i<7; i++){
        ...
        switch(i){
            ...
            case 6:
                tower36 = piece;
                structureObjs.push(new structureObjects(0.0, 2.9 , 7.8, 0.0, 0.0, 0.0, objType ));
                break;
        }
    }
}
...
function randomizePyramid(woodPyramid, glassPyramid, stonePyramid){
    for(let i=0; i<8; i++){
        ...
        switch(i){
            ...
            case 5:
                tower34 = piece;
                structureObjs.push(new structureObjects(0.0, 2.4 , 7.2, 0.0, 0.0, 0.0, objType ));
                break;
            case 6:
                tower35 = piece;
                structureObjs.push(new structureObjects(0.0, 2.4 , 8.6, 0.0, 0.0, 0.0, objType ));
                break;
            case 7:
                tower37 = piece;
                structureObjs.push(new structureObjects(0.0, 3.4 , 7.8, 0.0, 0.0, 0.0, objType ));
                break;
        }
    }
}
