...
function collides(objMoving){
	...
	structureObjs.forEach(function(obj) {
		...
		if(obj.tz - obj.radz < objMoving.tz + objMoving.radz && obj.tz > objMoving.tz + objMoving.radz && ((obj.ty + obj.rady > objMoving.ty - objMoving.rady + tollerance && obj.ty + obj.rady < objMoving.ty + objMoving.rady)  || (obj.ty - obj.rady < objMoving.ty + objMoving.rady - tollerance && obj.ty - obj.rady > objMoving.ty - objMoving.rady))){
			if(objMoving.vz >= 0.0001){
